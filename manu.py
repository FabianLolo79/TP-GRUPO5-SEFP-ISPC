...
def agregar_nuevo_disco():
    ...
    # Crear una consulta para insertar el disco en la base de datos
    query = "INSERT INTO discos (titulo, anio, artista, genero, precio, imagen_portada, canciones_lado_a, canciones_lado_b) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)"
    valores = (titulo, anio, artista, genero, precio, imagen_portada, str(disco[6]), str(disco[7]))
